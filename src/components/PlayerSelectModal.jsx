...
export default function PlayerSelectModal({ playerSelectModalOpen, setPlayerSelectModalOpen, currentPositionType, availablePlayers, addPlayerToPitch, selectedPlayers }) {
        ...
        <>
            <Modal className="squad-builder-tailwind" show={playerSelectModalOpen} onClose={() => setPlayerSelectModalOpen(false)}>
                    ...
                    <div className="space-y-6">
                        ...
                        :
                            <div className="text-center text-2xl">
                                <p>{translate("playerSelectModal.noMore")}</p>
                            </div>
                        }
                    </div>
                </Modal.Body>
                <Modal.Footer>
                    ...
                    text-center me-2 mb-2" onClick={() => setPlayerSelectModalOpen(false)}>{translate("playerSelectModal.closeModal")}</Button>
                </Modal.Footer>
            </Modal>
        </>
    );
